...
namespace GrayLark
{
    public partial class rptWarehouseview : Form
    {
        public rptWarehouseview(Object obj,String qm)
        {
            InitializeComponent();
            SendEmail(obj,qm); 
        }
        ...
        { 
                ...
                Apppath = Path.Combine(Apppath, "Report\\rptwarehouse.rpt");
                cryRpt.Load(Apppath); String v4 = "";
                String m = "select * from tbl_warehouse where W_Code ='" + q + "'";
            ...
            crystalReportViewer1.ReportSource = cryRpt;
                ...
                String name = "Warehouse " + DateTime.Now.ToString("dd-MM-yyyy") + q + DateTime.Now.ToString("MM_ss");
