...
namespace GrayLark
{
    public partial class AddExpense : Form
    {
        ...
        public AddExpense(Payment_voucher pv1, String Party)
        {
            InitializeComponent();
            pv = pv1; p1 = Party;
            load(); dataGridView1.Enabled = true; dataGridView1.ReadOnly = false;
        }
        ...
        try
        {
            String a1 = "select PurCode,VendorName,Date,NetAmount,PaidAmount,RemainingAmount from Purchase where RemainingAmount!=0 and VendorName='" + p1 + "'";
        ...
        try
        {
            String a1 = "select PurCode,VendorName,Date,NetAmount,PaidAmount,RemainingAmount from Purchase where RemainingAmount!=0 and VendorName='" + txtvendor.Text + "'";
        DataTable d1 = clsDataLayer.RetreiveQuery(a1); if (d1.Rows.Count > 0)
        {
            dataGridView1.DataSource = d1;
        }
