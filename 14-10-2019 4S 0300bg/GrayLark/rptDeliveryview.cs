...
namespace GrayLark
{
    public partial class rptDeliveryview : Form
    {
        public rptDeliveryview(Object obj,String qm)
        {
            InitializeComponent();
            SendEmail(obj,qm); 
        }
        ...
        { 
                ...
                String m = "select * from vdel where DCode ='" + q + "'";
            ...
            crystalReportViewer1.ReportSource = cryRpt;
                ...
                String name = "Delivery Challan " + DateTime.Now.ToString("dd-MM-yyyy") + q + DateTime.Now.ToString("MM_ss");
