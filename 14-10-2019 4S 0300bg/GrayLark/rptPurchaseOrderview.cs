...
namespace GrayLark
{
    public partial class rptPurchaseOrderview : Form
    {
        public rptPurchaseOrderview(Object obj,String qm)
        {
            InitializeComponent();
            SendEmail(obj,qm); 
        }
        ...
        { 
                ...
                String m = "select * from VU_Purchase where PurCode ='" + q + "'";
            ...
            crystalReportViewer1.ReportSource = cryRpt;
                ...
                String name = "Purchase Order " + DateTime.Now.ToString("dd-MM-yyyy") + q + DateTime.Now.ToString("MM_ss");
