...
namespace GrayLark
{
    ...
    {
        public rptInvoiceview(Object obj,String qm,String tbl)
        {
            InitializeComponent();
            SendEmail(obj,qm,tbl); 
        }
        ...
        private void SendEmail(Object obj,String q,String tbl)
        { 
                ...
                Apppath = Path.Combine(Apppath, "Report\\rptinvoice.rpt");
                cryRpt.Load(Apppath); String v4 = "";
                String m = "select * from "+tbl+ " where InCode ='" + q + "'";
            ...
            crystalReportViewer1.ReportSource = cryRpt;
                ...
                String name = "Invoice " + DateTime.Now.ToString("dd-MM-yyyy") + q + DateTime.Now.ToString("MM_ss");
